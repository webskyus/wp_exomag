...
$(function(){$(document).ready(function(){svg4everybody({})}),$(document).ready(function(){$(".menu-middle ul li").click(function(e){e.preventDefault(),$(".menu-middle ul li ul.active-submenu").removeClass("active-submenu"),$(this).find("> ul").toggleClass("active-submenu")})}),$(document).ready(function(){$(".menu-trigger").click(function(e){e.preventDefault(),$(".hidden-menu").toggleClass("hidden-menu-active"),$(".dark-desktop").addClass("dark-desktop-active")}),$(".close-btn").click(function(){$(".hidden-menu").removeClass("hidden-menu-active"),$(".dark-desktop").removeClass("dark-desktop-active")})}),$(document).ready(function(){$(".sidebar-slider, .posts-slider, .gallery-slider").slick({fade:!0,dots:!0,slidesToShow:1})}),$(document).ready(function(){$(".menu-search").click(function(e){e.preventDefault(),$(".search-box").css("transform","scale(1)"),$(".search-form ").addClass("active")}),$(".close-btn").click(function(e){e.preventDefault(),$(".search-box").css("transform","scale(0)"),$(".search-form ").removeClass("active")})}),$(document).ready(function(){$("img,a").on("dragstart",function(e){e.preventDefault()})}),$(window).scroll(function(e){$(this).scrollTop()>$(this).height()?($(".to-top").addClass("visible"),$(".to-top").removeClass("hidden")):($(".to-top").removeClass("visible"),$(".to-top").addClass("hidden")),$(".to-top").click(function(e){$("html, body").stop().animate({scrollTop:0},"slow")})}),$(document).ready(function(){AOS.init({duration:500,offset:200})}),$(document).ready(function(){$(".preloader").delay(1500).fadeOut("slow")})});